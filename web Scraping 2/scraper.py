...
headers = ["NAME", "LIGHT-YEARS FROM EARTH", "PLANET MASS",
           "STELLAR MAGNITUDE", "DISCOVERY DATE", "HYPERLINK", "PLANET_TYPE", "PLANET_RADIUS", "ORBITAL_RADIUS", "ORBITAL_PERIOD", "ECCENTRICITY"]
planet_data = []
new_planet_data=[]
...
for index, planet_data in enumerate(planet_data):
